      ...
      <div className="flex flex-col w-full gap-2 sm:flex-row sm:gap-8">
        <div>
          ...
          >
            ...
            <option value="Smartphones and Wearables">Smartphones and Wearables</option>
            <option value="Computers and Accessories">Computers and Accessories</option>
            <option value="Audio and Home Entertainments">Audio and Home Entertainments</option>
            <option value="Smart Home, Cameras and Lifestyle gadgets">Smart Home, Cameras and Lifestyle gadgets</option>
          </select>
        </div>
        <div>
